# config generated Thu Nov 17 23:13:23 UTC 2016
...
modules/readline/readline.so modules/readline/readline.sno modules/readline/snobol4readline.3 modules/readline/snobol4readline.3.html: xsnobol4 snolib/setuputil.sno modules/readline/setup.sno
	cd modules/readline; $(RUNSETUP) build

modules/sqlite3/sqlite3.so modules/sqlite3/sqlite3.sno modules/sqlite3/snobol4sqlite3.3 modules/sqlite3/snobol4sqlite3.3.html: xsnobol4 snolib/setuputil.sno modules/sqlite3/setup.sno
...
MODULES=dirs logic random stat time sprintf fork ndbm readline sqlite3 ffi
MODULES_LOADABLE= modules/dirs/dirs.so modules/logic/logic.so modules/random/random.so modules/stat/stat.so modules/time/time.so modules/sprintf/sprintf.so modules/fork/fork.so modules/ndbm/ndbm.so modules/readline/readline.so modules/sqlite3/sqlite3.so modules/ffi/ffi.so
MODULES_INCLUDE= modules/dirs/dirs.sno modules/logic/logic.sno modules/random/random.sno modules/stat/stat.sno modules/time/time.sno modules/sprintf/sprintf.sno modules/fork/fork.sno modules/ndbm/ndbm.sno modules/readline/readline.sno modules/sqlite3/sqlite3.sno modules/ffi/ffi.sno
MODULES_MAN= modules/dirs/snobol4dirs.3 modules/logic/snobol4logic.3 modules/random/snobol4random.3 modules/stat/snobol4stat.3 modules/time/snobol4time.3 modules/sprintf/snobol4sprintf.3 modules/fork/snobol4fork.3 modules/ndbm/snobol4ndbm.3 modules/readline/snobol4readline.3 modules/sqlite3/snobol4sqlite3.3 modules/ffi/snobol4ffi.3
MODULES_HTML= modules/dirs/snobol4dirs.3.html modules/logic/snobol4logic.3.html modules/random/snobol4random.3.html modules/stat/snobol4stat.3.html modules/time/snobol4time.3.html modules/sprintf/snobol4sprintf.3.html modules/fork/snobol4fork.3.html modules/ndbm/snobol4ndbm.3.html modules/readline/snobol4readline.3.html modules/sqlite3/snobol4sqlite3.3.html modules/ffi/snobol4ffi.3.html
MODULES_GENERATED=$(MODULES_LOADABLE) $(MODULES_INCLUDE)
TEST_SNOPATH=..:../modules/dirs:../modules/logic:../modules/random:../modules/stat:../modules/time:../modules/sprintf:../modules/fork:../modules/ndbm:../modules/readline:../modules/sqlite3:../modules/ffi:../snolib:.

/* $Id: data_init.c,v 1.12 2013/08/01 03:00:25 phil Exp $ */
...
const unsigned char ALPHA[] = {
    ...
    248, 249, 250, 251, 252, 253, 254, 255 /* NO COMMA! */
};

#define UCASSZ (sizeof(UCASE)-1)
const char UCASE[] = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
